...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_screenfull__ = __webpack_require__(1);
...
var directive = function directive(el, binding) {
    ...
    if (binding.value) {
      if (typeof binding.value === 'string') {
        ...
        var _binding$value = binding.value,
            ...
            options = _objectWithoutProperties(_binding$value, ['target']);

        currentTarget = target;
        currentOptions = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* extend */])(currentOptions, options);
      }
    }
    if (typeof currentTarget === 'string') {
      currentTarget = document.querySelector(currentTarget);
    }
    __WEBPACK_IMPORTED_MODULE_0__api__["a" /* default */].toggle(currentTarget, currentOptions);
  };
...
Component.options.__file = "/Users/mirari/Workspace/web/vue-fullscreen/src/component.vue"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_vue__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_screenfull__ = __webpack_require__(1);
...
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "screenfull", function() { return __WEBPACK_IMPORTED_MODULE_3_screenfull___default.a; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "directive", function() { return __WEBPACK_IMPORTED_MODULE_2__directive__["a"]; });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  install: function install(Vue) {
    ...
    Vue.component(name, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__utils__["a" /* extend */])(__WEBPACK_IMPORTED_MODULE_0__component_vue___default.a, { name: name }));
    Vue.prototype['$' + name] = __WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */];
    Vue.directive(name, __WEBPACK_IMPORTED_MODULE_2__directive__["a" /* default */]);
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    value: function value(_value) {
      if (_value !== this.isFullscreen) {
        _value ? this.request() : this.exit();
      }
    },
