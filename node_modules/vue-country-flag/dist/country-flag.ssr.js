...
var __vue_staticRenderFns__ = [];
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-0ba80393_0", { source: ".small-flag[data-v-0ba80393]{margin:-15px -22.5px;transform:scale(.25);-ms-transform:scale(.25);-webkit-transform:scale(.25);-moz-transform:scale(.25)}.normal-flag[data-v-0ba80393]{margin:-10px -15px;transform:scale(.5);-ms-transform:scale(.5);-webkit-transform:scale(.5);-moz-transform:scale(.5)}.big-flag[data-v-0ba80393]{margin:0}.small-flag.rounded[data-v-0ba80393]{-moz-border-radius:15px;border-radius:15px}.normal-flag.rounded[data-v-0ba80393]{-moz-border-radius:10px;border-radius:10px}.big-flag.rounded[data-v-0ba80393]{-moz-border-radius:8px;border-radius:8px}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-0ba80393";
  /* module identifier */
  var __vue_module_identifier__ = "data-v-0ba80393";
  /* functional template */
